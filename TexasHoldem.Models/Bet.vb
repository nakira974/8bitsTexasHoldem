...
Public Class Bet
    ...
    Public Sub New(ByVal threshold As Double, ByVal amount As Double, ByVal gambler As Player)
        Amount = If(Not (amount.Equals(0)) AndAlso (amount >= threshold), amount, CSharpImpl.__Throw(Of System.Int32)(New BetBelowThresholdException(threshold, amount, gambler)))
        Gambler = gambler
    End Sub
