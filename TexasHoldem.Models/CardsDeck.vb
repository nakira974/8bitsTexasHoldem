Public Class CardsDeck
    ...
    Public Shared ReadOnly MAXIMUM_DISTRIBUABLE_CARDS As Integer = 3
    Public Shared ReadOnly MINIMUM_DISTRIBUABLE_CARDS As Integer = 1
    ...
    Public Function DrawCards(ByVal cardsCount As Integer) As IEnumerable(Of Card)
        Try
            cardsCount =
                If _
                    (cardsCount >= MAXIMUM_DISTRIBUABLE_CARDS,
                     CSharpImpl.__Throw (Of System.Int32)(New TooManyCardsDealtException(cardsCount)), cardsCount)
